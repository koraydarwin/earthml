...
def check_noise(noise_type):
    """Checks whether the given noise_type is valid or not by looking its dimension. If noise_type is invalid, main function will not return data, it will not have shape."""
    flag = None
